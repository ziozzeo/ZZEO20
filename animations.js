...
function prova()
{
 ...
 if (state == 'complete') {
        setTimeout(function(){
            ...
            gsap.fromTo('#projtitle, #aboutesto, #desc',{y:15, opacity:0}, {y:0,opacity:1, duration:1.4, delay:1})
...
function gestmenu()
{
    if (chiudoapro==0){
        ...
        gsap.fromTo('#Rectangle-Copy',{rotation: 0, y:0},{rotation: -45,y:30, duration:0})
        gsap.fromTo('#Rectangle',{rotation: 0, y:0,x:0},{rotation: 45,y:1,x:2,duration:0})
        gsap.fromTo('.menuico',{y:0,x:0},{y:-60, x:40,duration:0})
        gsap.fromTo('#menulogo',{stroke:"#000"},{stroke:"#fff",duration:0})
    ...
    else
    {
        ...
        gsap.fromTo('#Rectangle-Copy',{rotation: -45,y:30},{rotation: 0,y:0, duration:0})
        gsap.fromTo('#Rectangle',{rotation: 45, y:1,x:0},{rotation: 0,y:0,x:0, duration:0})
        gsap.fromTo('.menuico',{y:-60,x:40},{y:0,x:0,duration:0})
        gsap.fromTo('#menulogo',{stroke:"#fff"},{stroke:"#000",duration:0})
