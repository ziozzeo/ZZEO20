...
document.getElementById('black').style.display="initial";
 ...
 if (state == 'complete') {
        setTimeout(function(){
            ...
            gsap.fromTo('.black',{x:0},{x:2000,duration:1,ease: "power4.inOut"})
...
function gestmenu()
{
    if (chiudoapro==0){
        ...
        gsap.fromTo('#menulogo',{stroke:"#000"},{stroke:"#988AA5",duration:.2})
    ...
    else
    {
        ...
        gsap.fromTo('#menulogo',{stroke:"#988AA5"},{stroke:"#000",duration:.2})
